...
<commons:popupHeader />
    ...
    <div id="main-body-content">
        <form:form id="createProperty" action="${pageContext.request.contextPath}/web/console/setting/property/submit/create" method="POST" commandName="property" cssClass="form">
            ...
            <fieldset>
                ...
                <div class="form-row">
                    ...
                    <span class="form-input"><form:input path="propertyLabel" cssErrorClass="form-input-error" size="30" /> *</span>
                </div>
                <div class="form-row">
