...
<commons:popupHeader />
    ...
    <div id="main-body-header">
        <fmt:message key="console.setting.scheduler.edit.label.title"/>
    </div>

    <div id="main-body-content">
        <form:form id="createScheduler" action="${pageContext.request.contextPath}/web/console/setting/scheduler/submit/edit" method="POST" commandName="schedulerDetails" cssClass="form">
