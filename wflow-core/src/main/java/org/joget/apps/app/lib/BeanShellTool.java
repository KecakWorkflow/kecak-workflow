...
public class BeanShellTool extends ExtDefaultPlugin implements ApplicationPlugin, ParticipantPlugin {
	...
	public Collection<String> getActivityAssignments(@SuppressWarnings("rawtypes") Map props) {
    ...
    protected Object executeScript(String script, @SuppressWarnings("rawtypes") Map properties) {
        Object result = null;
        try {
