...
public class JsonTool extends DefaultApplicationPlugin {
    ...
    protected void storeToForm(WorkflowAssignment wfAssignment, @SuppressWarnings("rawtypes") Map properties, @SuppressWarnings("rawtypes") Map object) {
    ...
    protected void storeToWorkflowVariable(WorkflowAssignment wfAssignment, @SuppressWarnings("rawtypes") Map properties, @SuppressWarnings("rawtypes") Map object) {
    ...
    protected Object getObjectFromMap(String key, @SuppressWarnings("rawtypes") Map object) {
        if (key.contains(".")) {
    ...
    protected FormRow getRow(WorkflowAssignment wfAssignment, String multirowBaseObjectName, Integer rowNumber, Object[] fieldMapping, @SuppressWarnings("rawtypes") Map object) {
