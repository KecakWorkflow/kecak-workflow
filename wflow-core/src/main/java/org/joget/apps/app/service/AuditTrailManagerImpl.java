...
public class AuditTrailManagerImpl implements AuditTrailManager {
     ...
     * @param returnObject 
     */
    public void addAuditTrail(String clazz, String method, String message, @SuppressWarnings("rawtypes") Class[] paramTypes, Object[] args, Object returnObject) {
    ...
    protected boolean dbLog(AuditTrail auditTrail) {
        ...
        if (c != null && m != null) {
            //login info
            if (m.equals("authenticate") || m.equals("logout") || c.startsWith("org.joget.directory.dao.") || c.endsWith("WorkflowManagerImpl") || c.endsWith("WorkflowToolActivityHandler") || c.endsWith("WorkflowAssignmentManager")) {
                return true;
            }
        }
