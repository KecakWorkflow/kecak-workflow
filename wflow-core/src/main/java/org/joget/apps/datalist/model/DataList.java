...
public class DataList {
    ...
    public void setRows(@SuppressWarnings("rawtypes") DataListCollection rows) {
        this.rows = rows;
    }
	...
	public void addDataListAction(String className, String type, @SuppressWarnings("rawtypes") Map properties) {
        try {
