...
public class ITextCustomFontResolver extends ITextFontResolver {
    ...
    @SuppressWarnings("unchecked")
	protected static void addCourier(@SuppressWarnings("rawtypes") HashMap result) throws DocumentException, IOException {
    ...
    @SuppressWarnings("unchecked")
	protected static void addTimes(@SuppressWarnings("rawtypes") HashMap result) throws DocumentException, IOException {
    ...
    @SuppressWarnings("unchecked")
	protected static void addHelvetica(@SuppressWarnings("rawtypes") HashMap result) throws DocumentException, IOException {
    ...
    protected static class FontFamily {
		...
		public FontDescription match(int desiredWeight, IdentValue style) {
			...
			Iterator i = _fontDescriptions.iterator(); i.hasNext();) {
