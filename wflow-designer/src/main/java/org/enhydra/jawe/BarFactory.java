         ...
         if (a instanceof NewActionBase && comp instanceof ChoiceButtonListener) {
            ...
            b = new JButton(label, ai) {
               /**
				 * 
				 */
				private static final long serialVersionUID = -7490031026576844351L;
            ...
            b = new JButton(ai) {
               /**
				 * 
				 */
				private static final long serialVersionUID = -418677152065567102L;
         ...
         if (a instanceof NewActionBase && comp instanceof ChoiceButtonListener) {
            ...
            b = new JButton(label) {
               /**
				 * 
				 */
				private static final long serialVersionUID = -4727611538609458230L;
