...
/**
 * Utility for implementing multi language support, and other manipulation with
 * property files.
 * 
 * @author Sasa Bojanic
 */
public class ResourceManager {
	...
	public static String getLanguageDependentString(AdditionalResourceManager arm, String nm) {
	...
	public static List getResourceStrings(Properties properties, String startsWith, boolean values) {
