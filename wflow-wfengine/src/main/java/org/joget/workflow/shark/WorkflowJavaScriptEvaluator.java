 ...
 */
 public class WorkflowJavaScriptEvaluator implements Evaluator {
	...
	public java.lang.Object evaluateExpression(WMSessionHandle shandle,
            ...
            @SuppressWarnings("rawtypes") Class resultClass) throws Exception {
    ...
    private void prepareContext(Scriptable scope, @SuppressWarnings("rawtypes") Map context, String procId, String actId)
            throws Exception {
